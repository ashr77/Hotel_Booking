...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            ...
            <Title title="Subscribe to our Newsletter" subTitle="Join our newsletter to receive the latest news and exclusive offers from our hotels. Stay updated on upcoming promotions, events, and travel tips to make the most of your next stay with us." align="center" />
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                    <img src={assets.arrowIcon} alt="arrow-icon" className="w-4 h-4 invert group-hover:translate-x-1 transition-all" />
                </button>
            </div>
